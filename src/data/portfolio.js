...
export const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      year: '2026',
      role: 'Developer',
      description: 'A modern and responsive landing page built to showcase a brand, its offerings, and key information through a clean and engaging interface.',
      stack: ['React', 'Tailwind CSS', 'Vite'],
    ...
    },
    {
      ...
      year: '2026',
      role: 'Developer',
      description: 'A modern school website designed to provide students, parents, and visitors with easy access to school information, programs, and updates.',
      stack: ['React', 'Tailwind CSS', 'Vite'],
    ...
    },
    {
      ...
      year: '2026',
      role: 'Developer',
      description: 'A beginner-friendly coding learning platform that provides structured lessons and practical resources to help users learn web development.',
      stack: ['React', 'Tailwind CSS', 'Vite'],
      link: 'https://dev-hub-psi-six.vercel.app',
    ...
    },
    {
      ...
      year: '2026',
      role: 'Developer',
      description: 'A simple expense management app that helps users record, monitor, and organize their spending for better financial awareness.',
      stack: ['React', 'Tailwind CSS', 'Vite'],
